...
@section("scripts")
    <script>
        var table = $('#tables').DataTable({
            ...
            "columnDefs": [
                ...
                },
                {
                    ...
                    "defaultContent": "<a type='button' class='btn btn-info col-xs-4 seats' >Seats</a>"
                }
            ]
        });
        ...
        $('#tables tbody').on('click', '.seats', function () {

            var data = table.row($(this).parents('tr')).data();
            console.log(data);
            window.location.href = '/admin/tables/' + data.id + '/seats';
        });
